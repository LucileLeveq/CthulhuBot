 ...
 * caractères de la phrase (en excluant les mots en -er, -ez et -ir)
 * Répondre à "Humain"
	...
	public void onEvent(Event event) {
		if (event instanceof MessageReceivedEvent) {
            ...
            if (!bot){ //On ne répond que si c'est pas un bot
	            ...
	            Pattern allemand = Pattern.compile("^[Dd]ie | [Dd]ie |[Kk]artoffeln?|schén| [Dd]er |^[dD]er | [Dd]as |^[dD]as |danke|guten?|nacht| ich |^[iI]ch | bin | ein |^[Ee]in ");
	            Pattern degueu = Pattern.compile("[Dd][Eeé][Gg][uU][Ee][Uu]");
	            Pattern toimeme = Pattern.compile("^.* ([A-Za-zzéêèôîïëüö]{4,}).*$");
